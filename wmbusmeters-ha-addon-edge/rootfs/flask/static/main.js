...
window.addEventListener('load', () => {
    ...
    function renderMqtt(values=['', '', '', '']) {
            ...
            let mqttFieldsHtml = '';
            const MQTT_FIELDS = ['field1', 'field2', 'field3', 'field4'];
    ...
    function renderSection(keys=['', '', ''], values=['', '', '']) {
        ...
        newSection.innerHTML = newSectionHtml + `<button class="add-pair btn btn-outline-success" type="button">Add field to section</button>
                    <button class="delete-section btn btn-outline-danger" type="button">Delete section</button><hr class="my-4">`;
